...
@section('body')
    <div class="container mt-3" style="">
        <div class="alert text-right">
            ...
            <b clas="mr-5"> عدد الزبائن : <span id="count_of_customers">{{ \App\Customer::count() }}</span> # </b>
            <hr>
            <div>
                <form id="formFilter">
        ...
        <table class="table table-striped" dir="rtl">
            ...
            <tbody id="customers">
                @include('layouts.divs.customer')
            </tbody>
        </table>
        {{-- show more button --}}
        @if ( \App\Customer::count() >= \App\Customer::$paginate )
...
@section('script')
    ...
    <script>
        var counts = {{ $customers->count() }};
        var paginate = {{ \App\Customer::$paginate }};
