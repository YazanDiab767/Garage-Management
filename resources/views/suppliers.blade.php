...
@section('body')
    <div class="container mt-3" style="">
        <div class="alert text-right">
            ...
            <b clas="mr-5"> عدد الموردون : <span id="count_of_suppliers">{{ \App\Supplier::count() }}</span> # </b>
            <hr>
            <div>
                <form id="formFilter">
        ...
        <table class="table table-striped" dir="rtl">
            ...
            <tbody id="suppliers">
                @include('layouts.divs.supplier')
            </tbody>
        </table>
        {{-- show more button --}}
        @if ( \App\Supplier::count() >= \App\Supplier::$paginate )
