                            ...
                            <div class="col-sm-12 ">
                                <nav>
                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><i class="fas fa-coins"></i> القطع ( <?php echo e(count($p)); ?> )</a>
                                ...
                                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <?php $__empty_1 = true; $__currentLoopData = $p; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <div class="alert alert-warning text-right">
                                                <b>
                                                    الكمية المتبقية من <?php echo e($part->name); ?> ( الرقم : <?php echo e($part->number); ?> ) : <?php echo e($part->count); ?>
                                    ...
                                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                        ...
                                        <?php $i = 0; ?>
                                        <?php $__empty_1 = true; $__currentLoopData = $s; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale_op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php
                                                $date = date("Y-m-d");
                                            ...
                                            <?php if($days >= 7): ?>
                                                ...
                                                <div class="alert alert-danger text-right">
                                                    <b>
                                                        <u> <?php echo e($sale_op->customer->name); ?> </u> :
                                                        عليه دين من تاريخ
                                                        <?php echo e($sale_op->created_at->toDateString()); ?>
                                        ...
                                        <?php endif; ?>
                                        <script>
                                            document.getElementById('count_debts').innerHTML = "<?php echo e($i); ?>";
                                        </script>
                                    </div>
                                </div>
