...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid" id="table">
        <div class="row justify-content-center" dir="rtl">
            <b> المورد : <?php echo e($supply_operations[0]->supplier->name); ?></b>
        </div>
        <br>
        <div class="row justify-content-center">
            <table class="table text-center"  dir="rtl" border>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <?php echo e($total_price); ?> شيكل </td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Garage Management\resources\views/reports/suppliers_operations.blade.php ENDPATH**/ ?>